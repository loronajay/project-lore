...
## Tone and storytelling guardrails

- Keep the fantasy grounded, physical, and human.
- Treat violence as frightening and consequential, not stylish wish fulfillment.
...
- Let buried truth arrive through pressure, behavior, memory, and consequence before it arrives through explanation.
...
- Keep Act 1 primarily anchored to Leo's limited understanding of the world around him.
...
- Preserve him as deeply feeling rather than emotionally numb or stoic.
...
- Preserve his lifelong gratitude and loyalty to the King as sincere before the betrayal is understood.
...
- Let his care read primarily through action rather than explanation or performed reassurance.
...
- Prefer updating the Markdown docs in this folder over the legacy `.txt` files.
- Keep `current-handoff.md` narrowly focused on the active story position.
- When the active beat changes, keep `current-handoff.md` and `act-1-outline.md` aligned with each other.
...
- When touching active-story canon, do a coherence pass across the relevant character, political, and structure docs so the shorthand does not drift.
